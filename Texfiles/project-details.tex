...
Figure~\ref{fig:erd-logical} illustrates the Entity Relationship Diagram (ERD) of the Digital Farmers’ Produce System, which presents the database structure of the proposed platform. The ERD identifies the main entities, their attributes, and the relationships among them. The USERS table serves as the central entity that stores information for farmers, buyers, and administrators. Other important entities include AREAS, POSTS, PRODUCE, POST\_IMAGES, POST\_INTERESTS, ANNOUNCEMENTS, NOTIFICATIONS, CONVERSATIONS, MESSAGES, RESOURCE\_REQUESTS, and SYSTEM\_LOGS.
\begin{figure}[H]
    \centering
...
\end{figure}
The ERD supports the major system functions such as user management, product posting, buyer interactions, communication, notifications, announcements, and resource requests. The relationships among entities illustrate how users are connected to areas, farmers manage produce posts, buyers express interest in products, and users communicate through conversations and messages. Overall, the ERD provides a structured and organized database design that promotes data consistency, efficient storage, and reliable system operation.
...
Figure~\ref{fig:usecase} presents the use case diagram of the proposed system, which involves four main actors: Super Admin, DA Staff, Farmer, and Buyer. The Super Admin manages user accounts and oversees system maintenance, while the DA Staff monitors platform activities, manages reports, and supervises product listings. Farmers are responsible for creating, editing, and managing agricultural product listings, whereas Buyers can browse, search, and inquire about available products.

The system includes major functions such as product management, messaging, notifications, reporting, resource requests, and system administration. Farmers and buyers communicate through the messaging feature, while notifications keep users updated on system activities. The diagram also illustrates inclusion relationships among system functions, such as adding, editing, and deleting products under product management. Overall, the use case diagram demonstrates how the platform supports agricultural product management, communication, monitoring, and administrative operations within a centralized digital system.
