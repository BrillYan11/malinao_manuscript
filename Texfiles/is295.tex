...
\renewcommand{\TITLE}{DIGITAL FARMERS’ PRODUCE SYSTEM: A CLOUD-BASED PLATFORM FOR OPTIMIZING CROP MANAGEMENT AND MARKET LINKAGES}
\renewcommand{\AUTHOR}{BRYAN N. MALINAO}
...
\begin{document}
	...
	\begin{frontmatter}
		...
		%ACKOWLEDGEMENT
            \include{Texfiles/acknowledgement}
